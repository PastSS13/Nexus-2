...
/client/proc/change_theme(datum/interface_theme/theme)
	...
	winset(src, "rpane.huelog", "text-color = [theme.ForegroundColor]; background-color = [theme.BackgroundColor]")
	winset(src, "rpane.changelog_next_day", "text-color = [theme.ForegroundColor]; background-color = [theme.BackgroundColor]")
